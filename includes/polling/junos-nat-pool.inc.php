 ...
 * the index is NOT used for address family -- a real walk of bgo-sg-fw
 * showed it as 0 on every single row regardless of family, while the
 * jnxJsNatSrcXlatedAddrType column (2) correctly reported 1 (ipv4) for
 * those same rows. The column value is the only reliable source of
 * family; see the two-pass aggregation below.
 */
